...
void LSLPBlit::update() {
	...
	const uint8_t *bits = blit_a(width, height);
		...
		for (int y = 0; y < 14; y++) {
			for (int x = 0; x < 15; x++) {
			uint8_t val = (0xff - bits[x + y * width]) >> 1;
			/*
...
const uint8_t *blit_a(uint16_t &width, uint16_t &height) {
	const uint8_t ret[] = {
		...
		
	};
