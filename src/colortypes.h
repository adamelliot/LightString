...
inline void add(TYPE *in, const TYPE val, uint8_t count) {
    for (uint8_t i = 0; i < count; i++) {
        in[i] += val;
    }
}
...
template <typename TYPE>
inline void add(TYPE *in, const TYPE *vals, uint8_t count) {
    for (uint8_t i = 0; i < count; i++) {
        in[i] += vals[i];
    }
}
...
template <typename TYPE>
inline void sub(TYPE *in, const TYPE val, uint8_t count) {
    for (uint8_t i = 0; i < count; i++) {
        in[i] -= val;
    }
}
...
template <typename TYPE>
inline void sub(TYPE *in, const TYPE *vals, uint8_t count) {
    for (uint8_t i = 0; i < count; i++) {
        in[i] -= vals[i];
    }
}
...
template <typename TYPE>
inline void mul(TYPE *in, const TYPE val, uint8_t count) {
    for (uint8_t i = 0; i < count; i++) {
        in[i] *= val;
    }
}
...
template <typename TYPE>
inline void div(TYPE *in, const TYPE val, uint8_t count) {
	for (uint8_t i = 0; i < count; i++) {
		in[i] /= val;
	}
}
